...
- Upon each season's end we will vote on any nominated rule changes. A rule change needs 8/12 "yes" votes for it to pass. There are no exceptions.
...
- 2nd Place: $50 (2 buy-ins)
- 3rd Place: $25 (1 buy-in)
- Regular Season Points Leader: $25 (1 buy-in)
...
- The first-round of the playoffs will have the #3 seed play the #6 seed, and the #4 and #5 seeds make up the other 1st round matchup. The #1 and #2 seeds receive a first-round bye.
